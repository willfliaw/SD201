...
files_debug = [
    ...
    [
        "../input_data/inc_debug_data1.csv",
        "../input_data/inc_debug_data2.csv",
    ],
]
...
def exercice11(files_to_study, **tree_params):
    ...
    for file in files_to_study:
        ...
        expected_results = labels[training_nb:]
        actual_results = []
        for i, (point_features, point_label) in enumerate(
            zip(features[training_nb:], labels[training_nb:])
        ):
            actual_results += [current_tree.decide(point_features)]
...
if __name__ == "__main__":
    ...
    if exercice == 1:
        ...
        results = exercice11(files_to_study, h=3, min_split_points=3, beta=0.5)
